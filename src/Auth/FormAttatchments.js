...
const FormA = () => {
  ...
  const [stateFunctions, setStateFunctions] = useState({
    ...
    idCardAttested: initialState,
    applicantPhotoAttested: initialState,
    appointmentLetterAttested: initialState,
    characterCertificate: initialState,
    certificateOfAppointment: initialState,
    affidavit: initialState,
    medicalCertificate: initialState,
    guardianIdCard: initialState,
    idCardPhoto1: initialState,
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        {renderAttachment("Applicant Photo (attested)", "applicantPhotoAttested")}
        {renderAttachment("Appointment Letter (attested)", "appointmentLetterAttested")}
        {renderAttachment("Character Certificate From Employers", "characterCertificate")}
        {renderAttachment("Certificate of Appointment", "certificateOfAppointment")}
        {renderAttachment("Affidavit (attested 1st class gazette Officer)", "affidavit")}
        {renderAttachment("Medical Certificate Counter Signed by M.S (Government Hospital)", "medicalCertificate")}
        {renderAttachment("Attested Copy of ID card of Guardian/Father/Husband", "guardianIdCard")}
        {renderAttachment("Id Card photo (1st person)", "idCardPhoto1")}
        {renderAttachment("Id Card photo (2nd person)", "idCardPhoto2")}
        {renderAttachment("Guarantee Letter (1st person)", "guaranteeLetter1")}
        {renderAttachment("Guarantee Letter (2nd person)", "guaranteeLetter2")}
