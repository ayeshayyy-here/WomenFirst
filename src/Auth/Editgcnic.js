...
const Editgcnic = () => {
  ...
  const handleSubmitRequest = async () => {
    try {
      ...
      formData.append('guardianf_cnic', { uri: cnicFront, name: 'cnic_gfront.jpg', type: 'image/jpeg' });
      formData.append('guardianb_cnic', { uri: cnicBack, name: 'cnic_gback.jpg', type: 'image/jpeg' });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <ImageUpload label="Guardian CNIC Front" image={cnicFront} onPick={() => pickImage(setCnicFront)} />
      <ImageUpload label="Guardian CNIC Back" image={cnicBack} onPick={() => pickImage(setCnicBack)} />
