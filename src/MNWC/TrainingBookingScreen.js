...
const COLORS = {
  ...
  primaryLight: '#ef4444',
  primaryDark: '#290606',
  primaryGradient: ['#6b0505', '#741d1d', '#361616'],
  primarySoft: '#fef2f2',
  secondary: '#f8f9fa',
  background: '#f4f7fb',
  surface: '#ffffff',
...
const TrainingBookingScreen = ({ route, navigation }) => {
  // ============ STATE MANAGEMENT ============
  ...
  const submitBooking = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/training-booking`, {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success',
        response.message || 'Training room booking request submitted successfully!',
            ...
            {submitting ? (
              ...
              <View style={styles.submitButtonContent}>
                ...
                <Text style={styles.submitButtonText}>
                  Submit Training Room Booking Request
                </Text>
              </View>
            )}
          </LinearGradient>
...
export default TrainingBookingScreen;