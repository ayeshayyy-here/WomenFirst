...
const COLORS = {
  ...
  primaryLight: '#085a26',
  primaryDark: '#043817',
  primaryGradient: ['#011308', '#164928', '#1c3625'],
  primarySoft: '#a7b4ab',
  secondary: '#f8f9fa',
  background: '#f4f7fb',
  surface: '#ffffff',
...
const OfficeBookingScreen = ({ route, navigation }) => {
  ...
  const validateForm = () => {
    ...
    if (!isEditMode) {
      if (!formData.applicant_pic) {
        Alert.alert('Validation Error', 'Upload Picture of Applicant is required');
        return false;
      }
  ...
  const submitBooking = async () => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/office-booking`, {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success',
        response.message || 'Office space booking request submitted successfully!',
  ...
  const renderInfoBox = () => (
    <LinearGradient 
      colors={['#98c1a4', '#d5e9d9']} 
      style={styles.infoBox}
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 0 }}
    >
      <Icon name="information" size={14} color="#0b1012" />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            ...
            <View style={styles.uploadsRow}>
              <View style={styles.halfWidth}>
                {renderImagePicker('applicant_pic', 'Upload Picture of Applicant', !isEditMode, 'JPG, PNG • Max 10MB')}
              </View>
              <View style={styles.halfWidth}>
            ...
            {submitting ? (
              ...
              <View style={styles.submitButtonContent}>
                ...
                <Text style={styles.submitButtonText}>
                  Submit Office Space Booking Request
                </Text>
              </View>
            )}
          </LinearGradient>
...
export default OfficeBookingScreen;