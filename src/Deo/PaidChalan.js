    ...
    <View style={styles.container}>
      ...
      <View style={styles.iconContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('PaidChalan')} style={styles.iconWrapper}>
          ...
          <Text style={styles.activeIconText}>Paid Chalans</Text>
        </TouchableOpacity>
      ...
      <Text style={styles.headerr}>View Paid Challans</Text>

      <FlatList
  data={chalans.filter(item => item.status === 'Paid')}
