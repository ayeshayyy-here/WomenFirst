...
import Application from '../../assets/images/requesttt.png';
...
import Twin from '../../assets/images/twin-beds.png';
...
const DashboardM = ({route, navigation}) => {
              ...
              <View style={styles.row}>
                ...
                >
                  ...
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Rooms (add/view)</Text>
                </TouchableOpacity>
         ...
         onPress={() => navigation.navigate('RoomsM')}
                >
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Residents Room Status</Text>
                </TouchableOpacity>
                </View>
                ...
                >
                  ...
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Rooms Approval Status</Text>
                </TouchableOpacity>
               
                <TouchableOpacity style={styles.card}
         onPress={() => navigation.navigate('ChangeRooms')}
                >
                  <Image
                    source={Sleep}
                    style={styles.cardIconn}
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Change Room Status</Text>
                </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity style={styles.card}
         onPress={() => navigation.navigate('VisitorGuestM')}
                >
                  <Image
                    source={Guest}
                    style={styles.cardIcon}
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Residents Visitors & Guests Logs</Text>
                </TouchableOpacity>
                    <TouchableOpacity style={styles.card}
                  ...
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Residents Attendance Tracker</Text>
                </TouchableOpacity>
                </View>
                <View style={styles.row}>
         ...
         onPress={() => navigation.navigate('Loginperson')}
                >
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Residents Login Tracker</Text>
                </TouchableOpacity>
         ...
         onPress={() => navigation.navigate('GenerateChalan')}
                >
                  <Image
                    ...
                    resizeMode="contain"
                  />
                  <Text style={styles.cardText}>Challans</Text>
               ...
               <TouchableOpacity style={styles.card}
        onPress={() => navigation.navigate('UpdateInformation', { status: 'pending' })} 
               >
                 <Image
                   source={Machine}
                   style={styles.cardIconn}
                   resizeMode="contain"
                 />
                 <Text style={styles.cardText}>Update Information</Text>
               </TouchableOpacity>
               <TouchableOpacity style={styles.card}
        onPress={() => navigation.navigate('DischargeM')} 
               >
                 <Image
                   source={Operation}
                   style={styles.cardIconn}
                   resizeMode="contain"
                 />
                 <Text style={styles.cardText}>Discharge Management</Text>
               </TouchableOpacity>
               </View>
               <View style={styles.row}>
               ...
               <TouchableOpacity style={styles.card}
        onPress={() => navigation.navigate('ComplaintsM')} 
               >
                 <Image
                   source={Interview}
                   style={styles.cardIconn}
