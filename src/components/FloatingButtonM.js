...
const FloatingButtonM = ({ onPress }) => {
  return (
    <TouchableOpacity style={styles.fabContainer} onPress={onPress}>
      <LinearGradient
        colors={['#010048', '#030022', '#632D61', '#020035', '#010048']}
        locations={[0, 0.14, 0.41, 0.73, 1]}
        start={{ x: 0, y: 1 }}
        end={{ x: 1, y: 0 }}
        style={styles.fab}
      >
...
const logoutUser = async () => {
  ...
  return (
    <View style={styles.container}>
      <FloatingButtonM onPress={handlePress} />
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.buttonRow}>
              <LinearGradient
                colors={['#010048', '#020035', '#632D61', '#020035', '#010048']}
...
const styles = StyleSheet.create({
  ...
  fabContainer: {
    position: 'absolute',
    bottom: '2%', // Increased to prevent overlap with other content
